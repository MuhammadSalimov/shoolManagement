...
const Header = () => {
  ...
  return (
    <div className="header">
      ...
      <button onClick={() => setSidebar(!sidebar)} id="mobile_btn" className="mobile_btn">
              ...
              <form action="#" className="dropdown">
                <div className="searchinputs" id="dropdownMenuClickable">
                  ...
                  <div className="search-addon">
                    <button type="submit"><MdKeyboardCommandKey /></button>
                  </div>
                </div>
              </form>
            </div>
          ...
          <div className="d-flex align-items-center">
            ...
            <DropdownMenu >
              <DropdownMenuTrigger className="me-2 mr-1" asChild>
                <button className="btn btn-outline-light fw-normal bg-white d-flex align-items-center p-2" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <DropdownMenuContent className="dropdown-menu show right-[-100px] dropdown-menu-right border shadow-sm dropdown-md">
                <DropdownMenuSeparator />
                <DropdownMenuRadioGroup value={acYear} onValueChange={setAcYear}>
                  <DropdownMenuRadioItem className="text-slate-400 py-3 flex justify-center" value="2023/2024">
                    Academic Year : 2023 / 2024
                  </DropdownMenuRadioItem>
                  <DropdownMenuRadioItem className="text-slate-400 py-3 flex justify-center" value="2022/2023">
                    Academic Year : 2022 / 2023
                  </DropdownMenuRadioItem>
                  <DropdownMenuRadioItem className="text-slate-400 py-3 flex justify-center" value="2021/2022">
            ...
            <DropdownMenu >
              <DropdownMenuTrigger className="pe-1 ms-1" asChild>
                <Button variant="outline" className="btn btn-outline-light bg-white btn-icon d-flex align-items-center me-1 p-2">
                  {position}
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent className="dropdown-menu right-[-70px] show dropdown-menu-right">
                ...
                <DropdownMenuRadioGroup value={position} onValueChange={setPosition}>
                  ...
                  <DropdownMenuRadioItem className="text-slate-400 " value="uzb">
                    Uzbek
                  </DropdownMenuRadioItem>
                  <DropdownMenuRadioItem className="text-slate-400 " value="esp">
                    Spanish
                  </DropdownMenuRadioItem>
                </DropdownMenuRadioGroup>
              </DropdownMenuContent>
            ...
            <Popover open={showBtns} onOpenChange={setShowBtns} >
              <PopoverTrigger onClick={() => setShowBtns(!showBtns)} className="w-[50px] h-[38px] mr-1" asChild>
              ...
              <PopoverContent className=" dropdown-menu show right-[-100px] dropdown-menu-right border shadow-sm dropdown-md">
                ...
                <div className="p-3 pb-0">
                  <div className="row gx-2">
                    <div className="col-6">
                      <Link onClick={() => setShowBtns(false)} to="/create-student" className="d-block bg-primary-transparent ronded p-2 text-center mb-3 className-hover">
                    ...
                    <div className="col-6">
                      <Link onClick={() => setShowBtns(false)} to="/create-teacher" className="d-block bg-success-transparent ronded p-2 text-center mb-3 className-hover">
                        <div className="avatar avatar-lg mb-2">
                    ...
                    <div className="col-6">
                      <Link onClick={() => setShowBtns(false)} to="/create-staffs" className="d-block bg-warning-transparent ronded p-2 text-center mb-3 className-hover">
                    ...
                    <div className="col-6">
                      <Link onClick={() => setShowBtns(false)} to="/create-invoice" className="d-block bg-info-transparent ronded p-2 text-center mb-3 className-hover">
                        <div className="avatar avatar-lg mb-2">
            ...
            {/* Dark mode */}
            <div className="pe-1" onClick={() => setIsDark(!isDark)}>
              {isDark ? <button type="button" id="dark-mode-toggle" className="dark-mode-toggle btn btn-outline-light bg-white btn-icon me-1 activate">
                <TbBrightnessUp />
              </button>
                : <button type="button" id="light-mode-toggle" className="dark-mode-toggle btn btn-outline-light bg-white btn-icon me-1 activate">
                  <TbMoon />
                </button>}
            </div>
            ...
            {/* Notification */}
            <Popover>
              <PopoverTrigger className="btn btn-outline-light bg-white btn-icon position-relative me-1" id="notification_popup" asChild>
                <button className="" >
                  <FaBell />
                ...
                <div className="d-flex align-items-center justify-content-between border-bottom p-0 pb-3 mb-3">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <div className="dropdown">
                      <button className="bg-white dropdown-toggle" data-bs-toggle="dropdown"><i className="ti ti-calendar-due me-1"></i>Today
                      </button>
            ...
            <Popover>
              <PopoverTrigger className="dropdown ms-1" asChild>
                <button className="dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
                  <span className="avatar avatar-md rounded">
                    <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Img" className="img-fluid" />
                  </span>
                </button>
              </PopoverTrigger>
                ...
                <div className="d-block">
                  <div className="d-flex align-items-center p-2">
                    <span className="avatar avatar-md me-2 online avatar-rounded">
                      <img className="w-full" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="img" />
                    </span>
                    <div>
                  ...
                  <hr className="m-0" />
                  <Link className="dropdown-item d-inline-flex gap-1 align-items-center p-2" to="/edit-profile">
                    <BiUserCircle /> My Profile</Link>
                  <Link className="dropdown-item d-inline-flex align-items-center p-2 gap-1" to="/edit-profile">
                    <CiSettings />
                    Settings</Link>
                  <hr className="m-0" />
